...
!=======================================================================================================
            Ham(1,2) = -t0*phi(1)
            Ham(48,47) = -t0*conjg(phi(1))
            Ham(len2+1,len2+2) = -t0*phi(1)
            Ham(len2+48,len2+47) = -t0*conjg(phi(1))
            Ham(len2*2+1,len2*2+2) = t0*phi(1)
            Ham(len2*2+48,len2*2+47) = t0*conjg(phi(1))
            Ham(len2*3+1,len2*3+2) = t0*phi(1)
            Ham(len2*3+48,len2*3+47) = t0*conjg(phi(1))

            Ham(48*47+1,48*47+1-48) = -t0
            Ham(len2+48*47+1,Len2+48*47+1-48) = -t0
            Ham(len2*2+48*47+1,Len2*2+48*47+1-48) = t0
            Ham(len2*3+48*47+1,Len2*3+48*47+1-48) = t0
            
            Ham(1,49) = -t0
            Ham(len2+1,len2+49) = -t0
            Ham(len2*2+1,len2*2+49) = t0
            Ham(len2*3+1,len2*3+49) = t0
